    ...
    <el-dialog :title="isEdit ? '编辑文章' : '新增文章'" v-model="dialogVisible" width="50%" @close="handleClose">
        <el-form :model="formData" :rules="rules" ref="formRef" label-width="120px">
            ...
            <el-form-item label="文章摘要" prop="summary">
                <el-input v-model="formData.summary" placeholder="请输入文章摘要(可选)" type="textarea" maxlength="1000"
                    show-word-limit :rows="4" />
            </el-form-item>
            <el-form-item label="标签" prop="tags">
                <el-select v-model="formData.tagArray" placeholder="请输入标签" multiple filterable allow-create
                    style="width: 100%;">
...
const handleClose = () => {
    ...
    //重置标签,因为之前显示标签是用的array数组，而handleRemove清除的是tags
    formData.tagArray = []
    //重置图片
    handleRemove()
    //关闭弹窗
