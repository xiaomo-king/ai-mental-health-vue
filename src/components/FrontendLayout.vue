    ...
    <div class="frontend-layout">
        <div class="navbar-container">
            <div class="brand-section">
                <el-image style="width: 50px; height: 50px" :src="iconUrl" alt="logo" class="brand-logs"></el-image>
            ...
            <div class="nav-section">
                ...
                <el-button size="medium" class="logout-btn" v-if="isLoggedIn" @click="handleLogout">退出登录</el-button>
                <template v-else>
