        ...
        <div class="sidebar">
            ...
            <div class="ai-assistant-info">
                <div class="breathing-circle">
                    <el-image style="width: 25px; height: 25px;" :src="iconUrl1" alt="AI助手"></el-image>
                </div>
                <h3 class="assistant-name">小梅AI助手</h3>
                ...
                <div class="warm-tips">
                    ...
                    <div class="warm-suggestion" v-if="currentEmotion.suggestion">
                        ...
                        <div class="suggestion-content">
                            <div class="suggestion-title">给您一个小建议</div>
                            <div class="suggeation-text">{{ currentEmotion.suggestion }}</div>
                        </div>
                    </div>
                    <!-- 治愈行动 -->
                    ...
                    <div v-for="session in sessionList" :key="session.id" @click="handleSessionClick(session)"
                        ...
                        <div class="session-info">
                            ...
                            <div class="session-actions">
                                <el-button text type="danger" size="mini" @click="handleDeteleSession(session.id)">
                                    <el-icon>
                                        <DeleteFilled />
                                    </el-icon>
                                </el-button>
            ...
            <div class="chat-header">
                <div class="header-left">
                    <div class="chat-avatar">
                        <el-image style="width: 30px; height: 30px;" :src="iconUrl2"></el-image>
                    </div>
                    <div class="chat-info">
                        <h2>小梅AI助手</h2>
                        <p>您的贴心AI心理健康助手</p>
            ...
            <div class="chat-messages">
                ...
                <div class="message-item ai-message" v-if="messages.length === 0">
                    <div class="message-avatar">
                        <el-image style="width: 18px;height: 18px;" :src="iconUrl1"></el-image>
                    </div>
                    <div class="message-content">
                        <div class="message-bubble">
                            <p>您好！我是小暖，您的AI心理助手，很高兴陪伴您，为您提供温暖的心理支持，请告诉我，今天您感觉怎么样？有什么想要分享的吗？</p>
                        </div>
                ...
                <div v-for="msg in messages" :key="msg.id" class="message-item"
                    ...
                    <div class="message-content">
                        ...
                        <div class="message-time">{{ msg.senderType === 2 && isAiTying ? '正在输入中...' : msg.createdAt }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="chat-input">
                <div class="input-container">
                    <el-input v-model="userMessage" placeholder="请输入您想要分享的内容..." type="textarea" :rows="3"
                        :disabled="isAiTying" @keydown="handleKeyDown" class="message-input" clearable />
...
const startNewSession = (message) => {
    ...
    if (currentSession.value.sessionTitle === '新对话') {
        sessionParams.sessionTitle = `小梅AI助手 - ${new Date().toLocaleString()}`
    } else {
        //如果是历史会话记录
...
const startAIResponse = (sessionId, userMessage) => {
    ...
    //调用流式接口
    const ctrl = new AbortController()//用来终止fetch请求的控制器
...
const handleDeteleSession = (sessionId) => {
