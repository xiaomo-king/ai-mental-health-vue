    ...
    <div class="knowledge-container">
        <div class="header-section">
            <div class="header-content">
                <el-image :src="imageUrl1" style="width: 60px; height: 60px"></el-image>
            </div>
        </div>
        <div class="content">
            <!-- 左侧菜单 -->
...
const imageUrl1 = new URL('@/assets/images/book.png',import.meta.url).href
...
const getImage = (url) =>{
    ...
    // 如果 url 包含完整地址（以 http 或 https 开头），则返回默认图片
